    ...
    <Container maxWidth="md">
      ...
      <form className="login">
        <header className="login_header">
          <div
            className={
              isSignUp ? "login_logoContainer" : "signup_logoContainer"
            }
          >
          ...
          <Typography variant="h1" className="login_subtitle">
            {isSignUp && "Make the most of your professional life"}
          </Typography>
        </header>
        <Card className="login_form">
          <CardContent>
            {!isSignUp && (
              <div>
                <h1 className="login_signInText">Sign in</h1>
                <p className="login_signInSubHeading">
            ...
            <TextField
              ...
              margin={isSignUp ? "dense" : "normal"}
              variant="outlined"
              {...(!isSignUp ? { placeholder: "Email or Phone" } : {})}
              InputLabelProps={{
                shrink: true,
              }}
            />
            {isSignUp && <label>Password (6 or more characters)</label>}
            <TextField
            ...
            {isSignUp && (
              <>
                ...
                <TextField
                  ...
                  margin={isSignUp ? "dense" : "normal"}
                  variant="outlined"
                  {...(!isSignUp ? { placeholder: "Password Confirmation" } : {})}
                  InputLabelProps={{
                    shrink: true,
                  }}
                />
          ...
          {!isSignUp && (
            <CardActions className="login_forgotPasswordContainer">
              <Button className="login_forgotPassword">Forgot Password?</Button>
            </CardActions>
          )}
          <CardActions>
            <Button className="login_submitButton" onClick={submitForm}>
      ...
      {isSignUp ? (
        <p className="login_joinNow">
          Already on LinkedIn?{" "}
          <Button
            className="login_changeMode"
